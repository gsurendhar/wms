...
<tr><td class="Blue-content">Datum</td><td><input  class="content style1" name="txtwmsl" value="<%=rs1.getString("wmsl")%>"/></td>
<td class="Blue-content">Sensor Height</td><td><input  class="content style1" name="txtmslp" value="<%=rs1.getString("mslpoint1")%>"/></td></tr>
