...
<%
  response.setIntHeader("Refresh",900); //in your case 60*5=300 (for 5 min)
%>
<%!
Connection con=null;
ResultSet rs=null;
...
String f = "C:/Program Files/Apache Software Foundation/Tomcat 9.0/webapps/wrdo/getcsv.txt";
//out.println(f);
...
<body>
<%
   String fName =  "C:/Program Files/Apache Software Foundation/Tomcat 9.0/webapps/wrdo/getcsv.txt";
   String thisLine;
  int count=0;
