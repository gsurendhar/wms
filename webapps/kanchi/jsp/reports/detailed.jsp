...
<select id="location" onchange="params()" class="content style1">
<option value="0">--Please Select--</option>
<option value="-1">All</option>
...
<table id="tblCustomers" width="100%" border="1" cacellpadding="0" cellspacing="0" id="stretch" > 
	<tr><td class="Headings" align="center" colspan=9 width="80%">All Data Detailed</td></tr>
...
<!--<td rowspan="2">Air_Pressure<br>(&nbsp;milibar&nbsp;)</td>--> 
...
%>
<tr  class="readonly">
<td><%=rs.getString("clientid")%></td><td><%=rs.getString("group_value")%>
<!--</td><td><%=rs.getString("county")%></td> -->
<td><%=rs.getString("location")%></td><td><%=rs.getString("date")%></td>
<!-- <td><%=rs.getString("latitude")%></td> <td><%=rs.getString("longitude")%></td> -->
<% if (rs.getString("water_height")==null){ %><td align="right">NA </td><%} else {%><td align="right"><%=rs.getDouble("water_height")%></td><%}%>
<% if (rs.getString("waterdepth_air")==null){ %><td align="right">NA</td><%} else {%><td align="right"><%=rs.getDouble("waterdepth_air")%></td><%}%>
<% if (rs.getString("water_pressure")==null){ %><td align="right">NA </td><%} else {%><td align="right"><%=rs.getDouble("water_pressure")%></td><%}%>
<!--<% if (rs.getString("air_pressure")==null){ %><td align="right">NA </td><%} else {%><td align="right"><%=rs.getDouble("air_pressure")%></td><%}%>-->
