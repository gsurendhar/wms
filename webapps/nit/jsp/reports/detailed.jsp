...
<tr><td><table id="tblCustomers" width="100%" border="1" cellpadding="0" cellspacing="0"  > 
	<tr>
<td class="headings" align="center" colspan="15"> All Data Detailed from <%=vfdate%> <%=vfhr%>:<%=vfmin%> Hrs to <%=vtdate%> <%=vthr%>:<%=vtmin%> Hrs</td>
</tr>
...
<td rowspan="2">Humidity<br>(&#37;)</td>
<!--
<td rowspan="2">Wind Speed<br>(&nbsp;m/sec&nbsp;)</td>
<td rowspan="2">Wind Direction<br>(&nbsp;degrees)</td>
<td rowspan="2">Gust </td>-->
<td rowspan="2">Local Pressure<br>(&nbsp;milibar&nbsp;)</td><td rowspan="2">MSLP<br>(&nbsp;milibar&nbsp;)</td> 

<td colspan="2">Rainfall(&nbsp;mm&nbsp;)</td>
<!--<td rowspan="2">Solar<br>Radiation</td>
<td rowspan="2">ePan</td>-->
<td colspan="3">soil Moisture(&nbsp;%&nbsp;)</td>
<!--<td rowspan="2">Soil Temp<br>(&nbsp;&deg;C&nbsp;)</td>
<td rowspan="2">Leaf<br>Wetness.<br>(&nbsp;Min&nbsp;)</td>-->
</tr>
...
<% if (rs.getString("evop_pan")==null){ %><td align="right">N/A</td><%} else {%><td align="right"><%=rs.getDouble("evop_pan")%></td><%}%>-->
