...
query="select msg,substr(receivedtime,1,19) as receivedtime,operator,id from (select * from ozekimessagein where sender='http' and msg like '%DLX-%' and id > "+vlid+" order by receivedtime desc)  as t ";
