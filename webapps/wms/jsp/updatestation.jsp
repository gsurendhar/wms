...
<td class="Blue-content">Address</td><td  colspan="3"><input  class="content style1" name="txtAddress" value="<%=rs1.getString("address")%>"></td></tr>
...
-->
<tr><td class="Blue-content">Contact Person</td><td><input  class="content style1"  name="txtcontact_person" value="<%=rs1.getString("contact_person")%>"></td>
<td class="Blue-content">Contact Phone</td><td><input  class="content style1"  name="txtcontact_phone" value="<%=rs1.getString("contact_phone")%>"></td>
<td class="Blue-content">Email</td><td><input  class="content style1"  name="txtemailid" value="<%=rs1.getString("emailid")%>"></td></tr>
