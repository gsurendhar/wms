...
rs=stmt.executeQuery(query);
  ...
  <td width="80%" VALIGN=TOP>
	<table width="100%" border="0" class=border cellpadding="4" cellspacing="4" bgcolor="" VALIGN=TOP>
		...
		<td class="Blue-content">Location Address</td><td class="readonly"  colspan="3"><%=rs.getString("address")%></td></tr>
		...
		<tr><td class="Blue-content">Wind Averaging</td><td class="readonly"><%=rs.getString("windavg")%></td>
		...
		<td class="Blue-content">Contact Phone</td><td class="readonly"><%=rs.getString("contact_phone")%></td>
		<td class="Blue-content">Email</td><td class="readonly"><%=rs.getString("emailid")%></td></tr>
