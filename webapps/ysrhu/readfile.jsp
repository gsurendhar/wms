...
String f = "C:/Program Files/Apache Software Foundation/Tomcat 9.0/webapps/ysrhu/getcsv.txt";
//out.println(f);
...
<body>
<%
   String fName =  "C:/Program Files/Apache Software Foundation/Tomcat 9.0/webapps/ysrhu/getcsv.txt";
   String thisLine;
  int count=0;
