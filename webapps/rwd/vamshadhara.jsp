...
<%try {
//String u1 = "http://api.msg91.com/api/v2/sendsms?authkey=180627AxbOUxrk2hP59ef82a0&mobiles=9989676040&message=hi&sender=Rivers&route=4&country=91";

String u = "http://api.msg91.com/api/v2/sendsms?authkey=180627AxbOUxrk2hP59ef82a0&mobiles=9959907790,8978080201,8978080215";
u+="&message= Vamshadahra water level is:"+vlid+" m and dateandtime is:"+vDatetime+" &sender=rivers&route=4&country=91";
...
BufferedOutputStream out1 = new BufferedOutputStream(file);
      ...
      out1.flush();
          out1.close();
          out.println("Vamshadara data Sucessfully sent");
}
catch(Exception ex)
        {
                out.println(ex);
