...
<table width="100%" border="0" cacellpadding="0" cellspacing="0" id="stretch" > 
	<tr><td class="Headings" align="center" width="100%">CURRENT HOUR RIVER GAUGE DATA OF NAGAVALI RIVER</td></tr>
...
query+="(select param_id,group_value from parameter) as par where dp.clientid=6000002 and  packet_type='D' ";
