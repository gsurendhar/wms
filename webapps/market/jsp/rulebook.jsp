...
catch(Exception e)
{
	...
	String vcomments=request.getParameter("txtComments");
...
<tr><td class="Blue-content"><b>Indicator:</b></td><td class="content style1"><%=rs.getString("NAME")%></td> </tr>
...
<tr><td class="Blue-content"><b>Comments:</b></td>
<td><input type=text id=txtComments name=txtComments  class="content style1" value="<%=rs.getString("Comments")%>" size="100"></td> </tr>
</tr>
<tr>
...
if ("Update".equalsIgnoreCase(act)){
		...
		if (vcomments!=null){query=query+",COMMENTS='"+vcomments+"'";}
		query+=" where id='"+vid+"'" ;
		//out.println(query);
...
act=null;
rs=stmt.executeQuery("select * from intraday.kpi_rules  order by  category,id ");
act="";
%>
...
<tr> <td colspan="5" align="Center" class="Headings">Rule List</td>
			<td align="right" colspan="7">
...
<td>Rule Type</td><td>Indicator</td>
<td>Value</td><td>Active</td>  <td>Comments</td>
...
<td align="left"><%=rs.getString("category")%>
