...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [9222601.544642, 2760218.993268, 9817116.941899, 3180196.926547], maxZoom: 19, minZoom: 1
    })
});


map.getView().fit([9222601.544642, 2760218.993268, 9817116.941899, 3180196.926547], map.getSize());
