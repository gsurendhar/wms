...
window.location.replace("dataanalysis.jsp?value1="+vid1+"&&value2="+vid2+"&&vfdate="+vfdate+"&&vtdate="+vtdate);
}
...
var vtdate= document.getElementById("tdate").value
var vparam= document.getElementById("param").value
window.location.replace("dataanalysis.jsp?value1="+vid1+"&&value2="+vid2+"&&vfdate="+vfdate+"&&vtdate="+vtdate+"&&param="+vparam);
}
