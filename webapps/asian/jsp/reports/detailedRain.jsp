...
window.location.replace("detailedRain.jsp?value1="+vid1+"&&value2="+vid2+"&&vfdate="+vfdate+"&&vtdate="+vtdate+"&&fhr="+vfhr+"&&fmin="+vfmin+"&&thr="+vthr+"&&tmin="+vtmin);
}
</script>
...
query+="(select clientid,longitude,latitude,location,state,district,county,wmsl,mslpoint1 from station_configs_det where address in ('ARG')) as scd ,";
