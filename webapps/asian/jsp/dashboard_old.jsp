...
<td>Station Statistics for AWS<br>(Last 12 Hours)</td>
<!--<td>Station Statistics for TRG<br>(Last 12 Hours)</td>-->
<td>Reporting stations for AWS<br>(Last 12 Hours) %</td>
...
<!--<td><iframe src="messagestats.jsp" height="300" width="300" FRAMEBORDER="0" scrolling="No"></iframe></td>
