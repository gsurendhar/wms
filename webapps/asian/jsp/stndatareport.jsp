...
window.location.replace("/wms/jsp/stndatareport.jsp?value1="+vid1+"&&value2="+vid2+"&&value3="+vid3+"&&value4="+vid4+"&&vfdate="+vfdate+"&&vtdate="+vtdate+"&&param="+vparam);
}
...
<td class="Blue-content">Wind<br> Direction</td><td class="Blue-content">Humidity</td><td class="Blue-content">Local Pressure</td><td class="Blue-content">MSLP</td></tr>
...
<%} else if ("Wind".equalsIgnoreCase(vparam) ) { %>
	<td class="Blue-content">Wind</td><td class="Blue-content">Wind<br>Direction</td></tr>
<%} else if ("Humidity".equalsIgnoreCase(vparam) ) { %>
	<td class="Blue-content">Humidity</td></tr>
<%} else if ("LocalPressure".equalsIgnoreCase(vparam) ) { %>
	<td class="Blue-content">Local Pressure</td></tr>
<%} else if ("MSLP".equalsIgnoreCase(vparam) ) { %>
<td class="Blue-content">Mean Sea-level Pressure</td></tr>
<%}%>
<%
...
<%} else if ("Rain".equalsIgnoreCase(vparam) ) { %>
	<td class="readonly"><%=rs.getDouble("rain")%></td></tr>
<%} else if ("Temparature".equalsIgnoreCase(vparam) ) { %>
	<td class="readonly"><%=rs.getDouble("temp")%></td></tr>
<%} else if ("Wind".equalsIgnoreCase(vparam) ) { %>
	<td class="readonly"><%=rs.getDouble("wind")%></td><td class="readonly"><%=rs.getDouble("wind_direction")%></td></tr>
<%} else if ("Humidity".equalsIgnoreCase(vparam) ) { %>
	<td class="readonly"><%=rs.getDouble("humidity")%></td></tr>
<%} else if ("LocalPressure".equalsIgnoreCase(vparam) ) { %>
	<td class="readonly"><%=rs.getDouble("local_pressure")%></td></tr>
<%} else if ("MSLP".equalsIgnoreCase(vparam) ) { %>
	<td class="readonly"><%=rs.getDouble("mslp")%></td></tr>
<%}%>
...
//ChartUtilities.saveChartAsJPEG(new File("C:\\Program Files (x86)\\Apache Software Foundation\\Tomcat 7.0\\webapps\\wms\\jsp\\chart.jpg"), chart, 900, 500);
