...
<td>Latitude</td>
<td>Logitude</td>
<td>Last Updated<br>before <br>Selected Date/time<br>(12hrs)</td>
<td>Rain (mm)</td>
</tr>
...
query=query+" to_timestamp('"+vfdate+","+vfhr+":"+vfmin+"','dd/mm/yyyy,hh24:mi') - INTERVAL '12 hours' and  to_timestamp('"+vfdate+","+vfhr+":"+vfmin+"','dd/mm/yyyy,hh24:mi') + INTERVAL '1 sec' group by clientid) as b where a.clientid=b.clientid and a.packet_date=b.packet_date) as y on (x.clientid=y.clientid) ";
