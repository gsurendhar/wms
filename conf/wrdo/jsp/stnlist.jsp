...
%>
<tr>
<td align="center" class="Blue-content">
		<script type="text/javascript">
			...
			document.write("Not Working Stations List as on : "+day + "/" + month + "/" + year)
		</script>
		</td>
</tr>
<%
...
<td class="Blue-content">Mandal</td><td class="Blue-content">Location</td><td class="Blue-content">Longitude</td>
